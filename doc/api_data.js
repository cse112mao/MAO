define({ "api": [
  ...
  {
    "type": "get",
    "url": "/formatTime/:strInputTime/:boolInputSeconds/:boolInput24Hour",
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "type": "Boolean",
            "optional": false,
            "field": "boolInput24Hour",
            "description": "<p>Check if we want the format in 24 hours or not</p>"
          }
        ]
      }
    },
  ...
  {
    "type": "get",
    "url": "/isValidTime/:strInputTime/:boolInputSeconds/:boolInput24Hour",
